...
from models.net import NoTextDualQueryRLFusion
from envs.crypto_env import CryptoFusionEnv

LOG_DIR = "./logs_NoTextDualQueryRLFusion/"
...
if __name__ == "__main__":
    ...
    # 5. 配置模型 (适配双通道输出的宽广特征)
    policy_kwargs = dict(
        features_extractor_class=NoTextDualQueryRLFusion,
    ...
    print(" 训练结束！最优模型已保存至 logs_NoTextDualQueryRLFusion/best_model.zip")